 ...
 * random letters on your keyboard. You want to know if you ever
 * typed the same letter twice, or if they are all unique letters.
 *
 * Task:
 * If you are given a string of random letters, your task is to evaluate
 * whether any letter is repeated in the string or if you only hit
 * unique keys while you typing.
 *
 * Input Format:
